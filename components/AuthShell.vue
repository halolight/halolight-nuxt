<template>
  <div class="relative h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
    <!-- 背景网格 -->
    ...
    <div class="relative flex h-full flex-col lg:flex-row overflow-auto">
      ...
      >
        <!-- 渐变背景 -->
        <div class="absolute inset-0" :class="leftGradient" />
        <!-- 网格 -->
      ...
      <div class="flex-1 flex items-center justify-center p-3 sm:p-4 lg:px-10 lg:py-6">
        <div class="w-full max-w-md">
          ...
          <!-- 卡片 -->
          <div class="border border-border/50 shadow-2xl backdrop-blur-xl bg-card/80 rounded-xl overflow-hidden">
            <!-- 顶部装饰线 -->
            <div class="h-1" :class="topLineGradient" />
...
withDefaults(defineProps<Props>(), {
  showLeft: true,
  leftGradient: 'bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700',
  leftTitle: '欢迎',
  leftEmoji: '👋',
  ...
  topLineGradient: 'bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600',
  haloColors: () => [
